  ...
  List<InventoryItem> _getDummyItems() {
    ...
    return [
      InventoryItem(
        ...
        quantity: 1.5,
        unit: 'L',
        expiryDate: DateTime(now.year, now.month, now.day, 10, 0),
      ),
      InventoryItem(
        id: '2',
        name: 'Organic Eggs',
        ...
        quantity: 6,
        unit: ' pcs',
        expiryDate: DateTime(now.year, now.month, now.day, 18, 0),
      ),
      InventoryItem(
        id: '3',
        name: 'Spinach',
        ...
        quantity: 200,
        unit: 'g',
        expiryDate: DateTime(now.year, now.month, now.day + 1, 12, 45),
      ),
      InventoryItem(
        id: '4',
        name: 'Salmon Fillet',
        ...
        quantity: 300,
        unit: 'g',
        expiryDate: DateTime(now.year, now.month, now.day + 1, 8, 0),
      ),
      InventoryItem(
        id: '5',
        name: 'Greek Yogurt',
        ...
        quantity: 500,
        unit: 'g',
        expiryDate: DateTime(now.year, now.month, now.day + 2, 14, 0),
      ),
    ];
  }
}
